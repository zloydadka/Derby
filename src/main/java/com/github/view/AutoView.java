...
public class AutoView extends AbstractView<Auto> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1514214263868616503L;

	public AutoView(AutoController controller) {
		
		super(controller, Auto.class);
	}
	...
	protected Map<String, String> engRusFieldMap() {
		...
		hashMap.put("stateNumber", "Госномер");
		hashMap.put("underRepair", "В ремонте");
	...
	protected String getTitleByMode() {	
		return mode.equals(Mode.NEW) ? "Добавление автомобиля" : "Редактирование автомобиля";		
	}
